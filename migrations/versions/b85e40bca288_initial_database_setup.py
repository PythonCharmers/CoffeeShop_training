...
Revision ID: b85e40bca288
Revises: 29d212dea594
Create Date: 2019-01-24 10:43:56.056861
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('rating', sqlalchemy_utils.types.choice.ChoiceType(SCORES), nullable=False),
